...
@section('contenido')
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Estudiante <small>Estudent</small></h1>
			</div>
			<p class="lead">El estudiante rsponsable cumple sus actividades a tiempo.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="{{ url('estudiante/estudiante') }}" method="post" enctype="multipart/form-data">
											@csrf
