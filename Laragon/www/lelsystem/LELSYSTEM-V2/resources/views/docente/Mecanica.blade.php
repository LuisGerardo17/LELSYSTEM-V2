...
<body>
    ...
    <main>
        <h1 align="center" class="malla"><b>CURSO DE MECÁNICA</b></h1>
        <section class="central">
            <div class="centro">
                <iframe
                    src="https://onedrive.live.com/embed?cid=CEF7ECDA44C549B4&amp;resid=CEF7ECDA44C549B4%214291&amp;authkey=AKyPmM4pc2a34GI&amp;em=2"
                ...
                <a href="{{route('mecanica')}}"><button type="button" class="aceptar">&nbsp;&nbsp;&nbsp;&nbsp;<i
