...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('static/css/estudiante.css') }}"/>
...
<body>
    <header class="cabecera">
        <div class="container-xl logo-container">
            <a href="#" class="logo"><b>PLATAFORMA @LELSYSTEM MODULO ESTUDIANTE</b></a>
            <nav class="lista">
                <ul>
                    @if(auth()->check())
                      <li class ="mx-8">
                ...
                <div class="row py-3">
                    <div class="col">
                        <div class="card carda" style="width: 18rem;">
                            <img src="../img/informatica.jpg" class="card-img-top" height="300px" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card carda" style="width: 18rem;">
                            <img src="../img/mecanica.jpg" class="card-img-top" height="300px" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card carda" style="width: 18rem;">
                            <img src="../img/electricidad.jpg" class="card-img-top" height="300px" alt="...">
                            <div class="card-body">
