...
<head>
	...
	<link rel="stylesheet" href="{{ asset('static/css/login/styles3.css') }}"/>
			...
			<nav class="menu">
				<ul class="nav lista">
					...
					<li class="nav-item sesiones">
						<a class="nav-link marign colorq" href="{{url('login')}}">Login</a>
                    </li>
					<li class="nav-item sesiones">
						<a class="nav-link marign colorq" href="{{url('register')}}">Registrate</a>
                    </li>
                </ul>
			</nav>
			<br><br><br><br>
		...
		<div class="container-xxl colorn">
			<div class="row">
				...
				<div class="col text-center pt-3">
					<img class="img" src="https://cdn.euroinnova.edu.es/img/subidasEditor/copia%20de%20sin%20t%C3%ADtulo%20-%202021-09-04t022424-1633085835.577" width="50%" alt="">
				</div>
			</div>
		</div>
		<div class="">
			<div class="row">
				<div class="col text-center pt-5">
					<img class="img2" src="https://colegionazaret.es/sites/colegionazaret.es/files/images/noticias/sofwareducativo2-830x500.jpg" width="60%" alt="">
				</div>
				<div class="col">
		...
		<div class="colorn">
			<div class="row">
				...
				<div class="col text-center pt-4">
					<img class="img" src="https://i.ytimg.com/vi/Z2mcSu0Gats/maxresdefault.jpg" width="50%" alt="">
				</div>
			</div>
		</div>
		<div class="">
			<div class="row">
				<div class="col text-center pt-4">
					<img class="img2" src="https://www.americaeconomia.com/media-library/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbWFnZSI6Imh0dHBzOi8vYXNzZXRzLnJibC5tcy8yNzEwNjIwMi9vcmlnaW4uanBnIiwiZXhwaXJlc19hdCI6MTY5MTM4Mjg0OH0.vgk9IcYhpCAYpCpV72llspBcBpb6O4xdQ9eiaGTa0_4/image.jpg?width=980" width="60%" alt="">
				</div>
				<div class="col">
